<template>
    ...
    >
    <div
        v-if="!error_message && carRequests.length == 0"
      ...
      >
        <div class="bg-blue-200 p-4 rounded-lg flex items-center shadow-md">
          ...
          <div class="p-4">
            <p class="text-lg font-bold">No car requests at the moment</p>
            ...
            <tbody class="text-gray-700">
              ...
              >
                <td class="border px-6 py-4">
                  <a
                    :href="'/customer_car_requests/' + car.id"
  ...
  export default {
    ...
    methods: {
      ...
      removeDriverCarRequests() {
        this.carRequests = this.carRequests.filter(car => {
            return car.user_id != this.user.id
        });
      },
      startPolling() {
        this.polling = setInterval(() => {
          this.fetchCarRequests(); // Fetch updated car request
